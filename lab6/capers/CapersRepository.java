...
public class CapersRepository {
    ...
    static final File CAPERS_FOLDER = Utils.join(CWD.toString(), ".capers");// TODO Hint: look at the `join`
                                            //      function in Utils
    /**
    ...
    public static void writeStory(String text) {
        ...
        if (!story_file.exists()) {
            ...
            String original_text = Utils.readContentsAsString(story_file);
            Utils.writeContents(story_file, original_text, "\n", text);
        }
    ...
    public static void celebrateBirthday(String name) {
        // TODO
        Dog bday_dog = Dog.fromFile(name);
        bday_dog.haveBirthday();
        bday_dog.saveDog();
    }
}
